...
def create_new_order():
    ...
    (customer_name, customer_address, customer_phone_number, courier_id, order_status, items) 
...
def update_order():
    ...
    new_customer_name = input("""What is the name of your customer? 
    Leave blank if you don't want to update the name: """).title().strip()      

    new_customer_address = input(f"""What is the new address? 
    Leave blank if you don't want to change the address: """).title().strip()

    new_customer_phone = input(f"""What is the new phone number? 
    Leave blank if you don't want to change the phone number: """).title().strip()
